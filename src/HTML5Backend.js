...
export default class HTML5Backend {
  ...
  setup() {
    ...
    this.el = this.el || document.querySelector(this.elSelector);
    if (this.el) {
      this.el.addEventListener('dragstart', this.handleTopDragStart);
      this.el.addEventListener('dragstart', this.handleTopDragStartCapture, true);
      this.el.addEventListener('dragend', this.handleTopDragEndCapture, true);
      this.el.addEventListener('dragenter', this.handleTopDragEnter);
      this.el.addEventListener('dragenter', this.handleTopDragEnterCapture, true);
      this.el.addEventListener('dragleave', this.handleTopDragLeaveCapture, true);
      this.el.addEventListener('dragover', this.handleTopDragOver);
      this.el.addEventListener('dragover', this.handleTopDragOverCapture, true);
      this.el.addEventListener('drop', this.handleTopDrop);
      this.el.addEventListener('drop', this.handleTopDropCapture, true);
    }
  }
  ...
  teardown() {
    ...
    this.el = this.el || document.querySelector(this.elSelector);
    if (this.el) {
      this.el.removeEventListener('dragstart', this.handleTopDragStart);
      this.el.removeEventListener('dragstart', this.handleTopDragStartCapture, true);
      this.el.removeEventListener('dragend', this.handleTopDragEndCapture, true);
      this.el.removeEventListener('dragenter', this.handleTopDragEnter);
      this.el.removeEventListener('dragenter', this.handleTopDragEnterCapture, true);
      this.el.removeEventListener('dragleave', this.handleTopDragLeaveCapture, true);
      this.el.removeEventListener('dragover', this.handleTopDragOver);
      this.el.removeEventListener('dragover', this.handleTopDragOverCapture, true);
      this.el.removeEventListener('drop', this.handleTopDrop);
      this.el.removeEventListener('drop', this.handleTopDropCapture, true);
    }
